...
"""
# Adapted from VDT (https://github.com/RERV/VDT, CC BY-NC 4.0), which derives
# from Meta's DiT (https://github.com/facebookresearch/DiT, CC BY-NC 4.0).
# Unlike the rest of this repository, this file is NOT MIT-licensed: it remains
# subject to CC BY-NC 4.0 (non-commercial use only). See NOTICE for details.
# --------------------------------------------------------
# References:
